...
<head>
    ...
    <link href="{{asset('public/themes/css/all.min.css')}}" rel="stylesheet" /> <!-- https://fontawesome.com/ -->
    <link href="{{asset('public/themes/slick/slick.css')}}" rel="stylesheet" /> <!-- https://kenwheeler.github.io/slick/ -->
    <link href="{{asset('public/themes/slick/slick-theme.css')}}" rel="stylesheet" />
	<link href="{{asset('public/themes/css/bootstrap.min.css')}}" rel="stylesheet" /> <!-- https://getbootstrap.com -->
	<link href="{{asset('public/themes/css/templatemo-new-vision.css')}}" rel="stylesheet" />
<!--
...
<body>
                        ...
                        <nav class="navbar navbar-expand-lg">
                          ...
                          <div class="collapse navbar-collapse tm-nav" id="navbarSupportedContent1">
                            ...
                            <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                <a class="nav-link tm-nav-link" href="{{asset('contact_us')}}">Contact</a>
                              </li>
                            </ul>
                            <!-- Links -->
            ...
            <section class="tm-welcome">
                ...
                <div class="row tm-welcome-row">
                    <article class="col-lg-6 tm-media">
                        <img src="{{asset('public/img/img-3x2-01.jpg')}}" alt="Welcome image"
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src="{{asset('public/img/img-3x2-02.jpg')}}" alt="Welcome image"
                         class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src="{{asset('public/img/img-3x2-03.jpg')}}" alt="Welcome image" class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src="{{asset('public/img/img-3x2-04.jpg')}}" alt="Welcome image" 
                        class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
            ...
            <section class="tm-featured">
                ...
                <div class="grid tm-carousel">
                    <figure class="effect-honey">
                        <img src="{{asset('public/img/gallery-item-01.jpg')}}" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Best</span> HTML Template</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="{{asset('public/img/gallery-item-02.jpg')}}" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Top</span> CSS Theme</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="{{asset('public/img/gallery-item-03.jpg')}}" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Best</span> HTML Template</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="{{asset('public/img/gallery-item-04.jpg')}}" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Great</span> Web Theme</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="{{asset('public/img/gallery-item-05.jpg')}}" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Best</span> HTML Collection</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="{{asset('public/img/gallery-item-06.jpg')}}" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Max</span> CSS Layout</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="{{asset('public/img/gallery-item-07.jpg')}}" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Best</span> HTML Layout</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="{{asset('public/img/gallery-item-08.jpg')}}" alt="Featured Item">
                        <figcaption>
    ...
    <script src="{{asset('public/themes/jquery-3.4.1.min.js')}}"></script>
    <script src="{{asset('public/themes/js/jquery-3.4.1.min.js')}}"></script>
    <script src="{{asset('public/themes/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('public/themes/js/templatemo-script.js')}}"></script>
</body>
</html>